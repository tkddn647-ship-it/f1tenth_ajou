...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 350.0
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 900.0
TRAJECTORY_BUILDER_2D.motion_filter.max_time_seconds = 0.03
TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.005
